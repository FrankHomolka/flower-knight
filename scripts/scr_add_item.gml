///scr_add_item(list, name, sprite, script, price, effectOnBuy, numBought, effectScript, *questScript, *questText, *questRarity, *description)
var list = argument[0];
var name = argument[1];
